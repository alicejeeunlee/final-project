...
export default class FavoriteDetail extends React.Component {
  ...
  makeCarouselItems(props) {
    return this.props.data.photoUrls.map((image, index) => {
      return (
            ...
            <div className='row mt-3'>
              <div className='col'>
                <div id="carousel" className="carousel slide">
                  <div className={this.props.data.photoUrls.length === 1 ? 'd-none' : 'carousel-indicators'}>
                    {this.makeIndicators(this.props)}
                  </div>
                  <div className="carousel-inner">
                    {this.makeCarouselItems(this.props)}
                  </div>
                  <button className={this.props.data.photoUrls.length === 1 ? 'd-none' : 'carousel-control-prev'} type="button" data-bs-target="#carousel" data-bs-slide="prev">
                    <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span className="visually-hidden">Previous</span>
                  </button>
                  <button className={this.props.data.photoUrls.length === 1 ? 'd-none' : 'carousel-control-next'} type="button" data-bs-target="#carousel" data-bs-slide="next">
