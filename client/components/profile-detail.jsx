            ...
            <div className='row'>
              <div className='col'>
                <div className='about-border pt-3 pb-3'>
                  ...
                  <h2 className={this.props.data.characteristics === null ? 'd-none' : 'detail-h2 ms-3'}>Characteristics</h2>
                  <p className='detail-p ms-5'>{this.props.data.characteristics}</p>
                  <h2 className={this.props.data.health === null ? 'd-none' : 'detail-h2 ms-3'}>Health</h2>
                  <p className='detail-p ms-5'>{this.props.data.health}</p>
                  <h2 className={this.props.data.home === null ? 'd-none' : 'detail-h2 ms-3'}>Good In A Home With</h2>
